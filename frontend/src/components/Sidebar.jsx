...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  return (
    <aside
      className={`bg-green-700 text-white h-screen fixed top-0 left-0 transition-all duration-100 ${
        isOpen ? 'w-64' : 'w-14'
      }`}
    >
      ...
      <footer className="p-0 mt-80">
        <li className="flex items-center text-white hover:bg-green-600 p-5 rounded">
          <FaSignOutAlt />
